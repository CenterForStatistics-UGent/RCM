...
estNBparamsNoLab = function(design, thetasMat,
    ...
    n, v, dynamic, envRange, preFabMat, allowMissingness) {
    ...
    nleq = nleqslv(x = initParam, reg = design,
        ...
        n = n, v = v, preFabMat = preFabMat, allowMissingness = allowMissingness)$x
    if (dynamic && ((-nleq[2]/(2 * nleq[3]) <
        ...
        nleq = c(nleqslv(initParam[-3], reg = design[,
            ...
            n = n, v = v - 1, allowMissingness = allowMissingness)$x, 0)
    }
    return(nleq)
}
