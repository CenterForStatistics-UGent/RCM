...
plot.RCM(zellerSphyRCMconstrLin, samColour = "Diagnosis", plotTaxa = TRUE, taxFrac = 0.015)
```
...
plot.RCM(zellerSphyRCMconstrLin, samColour = "Age", plotTaxa = TRUE, taxFrac = 0.015)
...
otherAnalyses = function(RCMlist, unifrac = FALSE, treeList = NULL, cores = 4){
    if(unifrac) {
      RCMlist = mapply(RCMlist, treeList, FUN = function(x,tree){
        x$physeq = phyloseq(otu_table(dat, taxa_are_rows = FALSE), tree)
