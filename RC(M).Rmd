...
if(!file.exists(file = "armpitRCM.RData")){
  ...
  armpitRCMconstrNonParam = RCM(armpit, covariates = sample_variables(armpit)[!sample_variables(armpit) %in% c("subject")], k=3, responseFun = "nonparametric", prevCutOff = 0.05)
