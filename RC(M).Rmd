...
groupsMeth = factor(c("Independence","Independence","Independence","Distance","Distance","Distance","Distance","Distance","Distance", "CoDa", "RCM"), levels = c("Independence","Distance","CoDa","RCM"), ordered = TRUE)
...
dd = as.dist(cophenetic.phylo(randomTree)) #Get branch lenghts
...
IDlistPhy = lapply(datListPhy[listID], function(x){
   taxa = apply(x$IDsampled, 2, function(y){rownames(x$rhosSampled)[as.logical(y)]})
   })
