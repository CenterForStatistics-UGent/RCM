...
plot(CMETRCMquad)
plot(CMETRCMquad, samColour = "ph")
plot(CMETRCMquad, samColour = "temp")
plot(CMETRCMquad, samColour = "Conductivity")
plot(CMETRCMquad, samColour = "cellDensity")
plot(CMETRCMquad, samColour = "Reactor.phase")
plot(CMETRCMquad, samColour = "Timepoint")
plot(CMETRCMquad, samColour = "collection_date")
plot(CMETRCMquad, samColour = "Reactor.cycle")
```
