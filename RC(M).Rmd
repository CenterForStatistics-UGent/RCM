...
reqpkg <- c("phyloseq","MASS", "parallel","nleqslv", "edgeR", "VGAM","HMP", "ggplot2", "pscl", "vegan", "alabama", "zCompositions", "DirFactor")
...
CoDa = function(dat, abCutOff = 1e-6){
...
# Apply PCA
prcomp(Xcrl) #Shouldn't this be scaled? It is not the default, and was not done by Gloor and Reid
}
```
...
nonParamBayes = function(dat, hyper = list( nv = 3, a.er = 1, b.er = 0.3, a1 = 3, a2 = 4, m = 10, alpha = 10, beta = 0 )){
  ...
  mcmc = DirFactor(t(dat), hyper, step = 100)
}
...
CodaReslist1 = 
BCresList1 = 
save(RCMresList1, file = "RCMsim/resList1.RData")
...
distanceFun = function(coord, clusters){
...
The silhouette can take values between +1 for optimal separation and -1 for wrong classification. We can averag the silhouttes over the ordination or jus look at their distribution to compare the ordination methods.

```{r silhouette}
silhouette = function(coord, clusters){
  # @param coord: an nxk matrix of coordinates
  # @param clusters: a factor of length n with cluster memberships
