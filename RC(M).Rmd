...
knitr::opts_chunk$set(cache = TRUE, autodep = TRUE,  warning = FALSE, message=FALSE, echo=FALSE, eval=FALSE, tidy = TRUE, fig.width = 9, fig.height=6, purl=TRUE, fig.show = "hold", cache.lazy = FALSE)
...
```{r resList0b sampleBiplot, purl = FALSE, include=FALSE}
#A sample biplot
...
```{r libSizeCorr0b, purl = FALSE, fig.cap = "Correlations of row scores with library sizes, results of 10b0b simulations shown for first two dimensions. Red diamonds indicate means.\\label{fig:libCor1}"}
...
```{r resList0bcols sampleBiplot, purl = FALSE, include = FALSE}
#A sample biplot
...
```{r AbsCorr0b, purl = FALSE, fig.cap = "Correlations of column scores with average relative abundances, results of 10b0b simulations shown for first two dimensions. Red diamonds indicate means.\\label{fig:libCor1}"}
