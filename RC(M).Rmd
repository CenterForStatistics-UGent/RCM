...
labelsMeth = c("CA","Hellinger","Bray-Curtis","Bray-Curtis Crel","Jenssen-Shannon divergence","CoDa","RCM")
groupsMeth = factor(c("SVD","SVD","PCoA","PCoA","PCoA","CoDa","RCM"))
```
...
save(datListHum, IDlistHum, groupFactorHum, resListSimSeqHumRows, resListSimSeqHumCols, file = "RCMsim/resListSimSeq.RData")
