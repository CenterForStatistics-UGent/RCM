...
obj = resList2Rows[[ID]]
foo =lapply(names(obj),function(x){plot(obj[[x]], col = groupFactor2, main=x, xlab = "Dim 1",ylab = "Dim 2", pty = "s")})
rm(ID, obj)
par(mfrow = c(1,1))
...
foo = lapply(names(obj),function(x){plot(obj[[x]], col = groupFactorZINB, main=x, xlab = "Dim 1",ylab = "Dim ZINB", pty = "s")})
rm(ID, obj)
par(mfrow = c(1,1))
# In this setting, the RCM really appears to outperform the other methods
