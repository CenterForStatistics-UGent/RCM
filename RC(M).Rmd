...
Our method bears some resemblance to the GOMMS-method proposed by Sohn and Li (2017). The aim of their method is to identify latent factors that optimally represent the microbiome count data in a low dimensional subspace. Still they only use the sample factors estimated this way, and do not go into making
