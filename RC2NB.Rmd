...
rowScores1 = rnorm(Nsamples-Nsamples%%2, sd=8)  + rChange1
rowScores2 = rnorm(Nsamples-Nsamples%%2, sd=5) + rChange2

#Taxa 1-10 and Nsamples - 1 - -10 have increased col scores 1
#Taxa 6-15 and Nsamples -6 - -15 have increased col scores 2
cChange1 = c(rep(0,10),rep(25,10), rep(0, Ntaxa-30), rep(25,10))
cChange2 = - c(rep(0,5),rep(2,15), rep(0, Ntaxa-40), rep(2,15), rep(0,5))

cid1 = cChange1!=0
cid2 = cChange2!=0

colScores1 = rnorm(Ntaxa-Ntaxa%%2, sd = 8) + cChange1
colScores2 = rnorm(Ntaxa-Ntaxa%%2, sd = 5) + cChange2
...
cid1 = cid1[ colSums(dataMat4) > 0]
cid2 = cid2[colSums(dataMat4) > 0 ]
...
# cid1 = cid1[ names(thetas) %in% colnames(dataMat4)]
# cid2 = cid2[names(thetas) %in% colnames(dataMat4) ]
...
save(DMsol,dataMat4DMtrim, pi, piSignal1, piSignal2,x,y,signalStrength, AGdm,dmrid1, dmrid2, dmcid1, dmcid2, file="toyDataDMRes.RData")
