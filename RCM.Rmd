...
rm(resList0bRows, resList0b, datList0b);gc()
```
...
rm(resList1Rows, resList1, datList1, resList1Cols);gc()
```
...
contrPlot(contr2)
rm(resList2Rows, datList2, resList2Cols, contr2);gc()
```
...
contrPlot(contr3)
rm(resList3Rows, resList3, datList3, resList3Cols, contr3);gc()
```
...
rm(resList4Rows, resList4, datList4, resList4Cols);gc()
```
...
contrPlot(contr5)
rm(resList5Rows, resList5Cols, contr5, datList5, IDlist5);gc()
rm(physeqListV13);gc()
```
...
rm(resListPhyRows, resListPhy, datListPhy, resListPhyCols, contrPhy);gc()
```
...
contrPlot(contrZINB)
rm(resListZINBRows, resListZINB, datListZINB, resListZINBCols, contrZINB);gc()
```
...
contrPlot(contrDM)
rm(resListDMRows, resListDM, datListDM, resListDMCols, contrDM);gc()
```
...
datListHum = lapply(HumSimSeqList, function(x){x$data})
...
datListZeller = lapply(ZellerSimSeqList, function(x){x$data})
...
rm(resListZellerRows, resListZeller, datListZeller, resListZellerCols, contrZeller);gc()
```
