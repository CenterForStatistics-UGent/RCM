...
plotRespFun(ZellerRCM2constrNonParam, Dim = 1, taxa = taxaDrawn, yLocVar = -6)
```
...
plotRespFun(ZellerRCM2constrNonParam, Dim = 1, taxa = FusoSpecies, yLocVar = NULL, samShape = "Diagnosis")
```
...
plotRespFun(ZellerRCM2constrNonParam, Dim = 2, taxa = taxaDrawn, yLocVar = -8, samShape = "Diagnosis")
```
