...
rm(resList2Rows, resList2, datList2, resList2Cols);gc(verbose = FALSE)
...
contrZeller = contrTaxaWrap(resListSimSeqZellerRows, resListSimSeqZellerCols, IDlistZeller, groupFactorZeller)
