...
CorDF0blib = makeCorDf(resList0bRows, datList0b, scoreDim = "rows", dataMat = TRUE, groupMeth = groupsMeth)
CorDF0btax = makeCorDf(resList0bCols, datList0b, scoreDim = "columns", dataMat = TRUE, groupMeth = groupsMeth)
...
```{r sil0b, fig.cap = "Boxplots of silhouettes in the first three dimensions by ordination method for 100 simulations with the negative binomial under H1 with 4 unrelated sample groups. Orange diamonds indicate means.\\label{supfig:sil0b}"}
plotSil(SilDF0b)
```
