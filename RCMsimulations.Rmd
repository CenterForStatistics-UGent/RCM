...
resList0 = otherAnalyses(RCMresList0, cores = 4)
...
CorDF2disp = makeCorDf(resList2Cols, datList2, scoreDim = "columns", dataMat = TRUE, groupMeth = groupsMeth, dispersion = TRUE)
