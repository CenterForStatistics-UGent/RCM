...
plot(ZellerRCM2,
    plotType = "species", taxRegExp = "Fusobacter",
    taxLabels = TRUE
)
```
...
tmpPlot <- plot(ZellerRCM2,
    taxNum = 10, samColour = "Diagnosis",
    returnCoords = TRUE
)
addOrthProjection(tmpPlot,
...
plot(ZellerRCM3,
    plotType = "species", taxCol = "Deviance", samSize = 2.5,
...
# Nonparametric
ZellerRCM2constrNonParam <- RCM(Zeller,
    round = TRUE, k = 2,
    covariates = c(
        "Age", "Gender", "BMI", "Country",
        "Diagnosis"
...
plot(ZellerRCM2constr,
    plotType = c("samples"), samColour = "Diagnosis",
    samShape = "Country"
)
```
...
```{r plotlin2corVis}
tmpPlot2 <- plot(ZellerRCM2constr,
    plotType = c("species", "samples"),
    returnCoords = TRUE
)
addOrthProjection(tmpPlot2,
...
```{r plotlin3Vis}
tmpPlot3 <- plot(ZellerRCM2constr,
    plotType = c("species", "variables"),
    returnCoords = TRUE
)
addOrthProjection(tmpPlot3,
    species = "Pseudomonas fluorescens",
...
FusoSpecies <- grep("Fusobacterium",
    value = TRUE,
    taxa_names(ZellerRCM2constrNonParam$physeq)
)
plotRespFun(ZellerRCM2constrNonParam,
    Dim = 1, taxa = FusoSpecies,
    samShape = "Diagnosis"
)
```
...
```{r inflAgeFast2}
plot(ZellerRCM2constr,
    plotType = c("variables", "samples"), inflVar = "Age",
...
```{r plotFewVars}
plot(ZellerRCM3constr,
    plotType = "samples", samColour = "Diagnosis",
    samShape = "Country"
)
```
