...
<!-- \textbf{Important note:} The package has been upgraded for use with the future 2.3.0 version of the $ggplot2$ package. This version can be installed as: -->

<!-- ```{r ggplot2Install, echo = TRUE, eval = FALSE} -->
...
```{r plotnonParamRespFunFuso, eval = FALSE}
