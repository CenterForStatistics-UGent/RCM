...
Confusion often arises as to why less distinct sample dots are shown than there are samples. This occurs when few, categorical constraining variables are supplied as below.
...
by influence by provinding the "inflVar" argument:
